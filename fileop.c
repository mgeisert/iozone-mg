...
int main(int argc, char **argv)
{
	...
	for(i=lower;i<=upper;i+=incr)
	{
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("mkdir:   Dirs = %9ld ",(long)stats[_STAT_DIR_CREATE].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("chdir:   Dirs = %9ld ",(long)stats[_STAT_DIR_TRAVERSE].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	   printf("rmdir:   Dirs = %9ld ",(long)stats[_STAT_DIR_DELETE].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("create:  Files = %9ld ",(long)stats[_STAT_CREATE].counter);
#else
...
#ifdef NO_PRINT_LLD
	      printf("write:   Files = %9ld ",(long)stats[_STAT_WRITE].counter);
#else
...
#ifdef NO_PRINT_LLD
	      printf("close:   Files = %9ld ",(long)stats[_STAT_CLOSE].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("stat:    Files = %9ld ",(long)stats[_STAT_STAT].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("open:    Files = %9ld ",(long)stats[_STAT_OPEN].counter);
#else
...
#ifdef NO_PRINT_LLD
	      printf("read:    Files = %9ld ",(long)stats[_STAT_READ].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("access:  Files = %9ld ",(long)stats[_STAT_ACCESS].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("chmod:   Files = %9ld ",(long)stats[_STAT_CHMOD].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("readdir: Files = %9ld ",(long)stats[_STAT_READDIR].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("link:    Files = %9ld ",(long)stats[_STAT_LINK].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("unlink:  Files = %9ld ",(long)stats[_STAT_UNLINK].counter);
#else
	   ...
	   {
#ifdef NO_PRINT_LLD
	      printf("delete:  Files = %9ld ",(long)stats[_STAT_DELETE].counter);
#else
